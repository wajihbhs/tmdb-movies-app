...
export const useMovieStore = defineStore("movieStore", () => {
  ...
  const hasMorePages = computed(() => !endReached.value && page.value < totalPages.value);
  ...
  const fetchMovies = async () => {
    ...
    try {
      const data: MovieResponse = await fetchMoviesWithFilters(currentFilters.value, page.value);
